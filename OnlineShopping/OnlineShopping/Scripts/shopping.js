    ...
    $.ajax({
        ...
        success: function (response) {
            if (response == "OK") {
                ...
                emptyCartItems();
                location.href = "/Home"; //tự động chuyển trang
            }
            else {
                alert(response);
            }
...
$(document).ready(function () {
    $(".btnAddToCart").click(function () {
        var a = $(this); //thẻ a này, để lấy a. cho dễ
        addItem(a.attr("pid"), a.attr("pname"), a.attr("punit"), a.attr("pprice"));
        return false; //do nó là thẻ a, nên return false để tránh siêu liên kết
    })
    loadCartItems();
